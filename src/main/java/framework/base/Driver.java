...
public class Driver {
    ...
    public static synchronized void initDriver(String browser, String seleniumType) {
        ...
        try {
            seleniumType = seleniumType.trim().toLowerCase();
            switch (seleniumType) {
                case "grid":
                    ...
                    switch (browser) {
                        ...
                        case "firefox":
                            ...
                            break;
                        default:
                            Log.warn("{}Browser selected was not in the list({}). Defaulting to Chrome browser.", methodName, browser);
                        case "chrome":
                    ...
                    break;
                default:
                    Log.warn("{}Selenium type was not specified (Option: Grid or WebDriver). Defaulting to Selenium WebDriver.", methodName);
                case "webdriver":
                    switch (browser) {
                        case "edge":

...
public class Infor_Exam2 extends BaseTest{
    ...
    public void TestScenario2() {
        infor_TC1_Login2(1);
        infor_TC2_Registration2();
        infor_TC3_LoginViaConfigFile2();
    }

    @Parameters({"count"})
    @Test(enabled=true)
    public void MultipleTCRunner2(@Optional("1")String count) {
    ...
    public void infor_TC1_Login2(@Optional("1")int count) {
    ...
    @Test
    public void infor_TC2_Registration2() {
    ...
    @Test
    public void infor_TC3_LoginViaConfigFile2() {

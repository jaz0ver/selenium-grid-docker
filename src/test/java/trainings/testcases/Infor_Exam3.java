...
public class Infor_Exam3 extends BaseTest{
    ...
    public void TestScenario3() {
        infor_TC1_Login3(1);
        infor_TC2_Registration3();
        infor_TC3_LoginViaConfigFile3();
    }

    @Parameters({"count"})
    @Test(enabled=true)
    public void MultipleTCRunner3(@Optional("1")String count) {
    ...
    public void infor_TC1_Login3(@Optional("1")int count) {
    ...
    @Test
    public void infor_TC2_Registration3() {
    ...
    @Test
    public void infor_TC3_LoginViaConfigFile3() {

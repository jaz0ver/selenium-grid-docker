...
public class Infor_Exam4 extends BaseTest{
    ...
    public void TestScenario4() {
        infor_TC1_Login4(1);
        infor_TC2_Registration4();
        infor_TC3_LoginViaConfigFile4();
    }

    @Parameters({"count"})
    @Test(enabled=true)
    public void MultipleTCRunner4(@Optional("1")String count) {
    ...
    public void infor_TC1_Login4(@Optional("1")int count) {
    ...
    @Test
    public void infor_TC2_Registration4() {
    ...
    @Test
    public void infor_TC3_LoginViaConfigFile4() {
